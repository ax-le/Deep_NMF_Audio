Pour faire fonctionner le code, il faut installer des librairies supplémentaires:
- librosa (pour calculer les spectrogrammes, 'pip install librosa')
...
- mir_eval (pour calculer les scores, 'pip install mir_eval')
